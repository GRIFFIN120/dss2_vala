...
public class PanoramaBean extends FileEntity {
    ...
    @JoinTable(name="panorama_domain",
            joinColumns={@JoinColumn(name="panorama_id")},inverseJoinColumns=
